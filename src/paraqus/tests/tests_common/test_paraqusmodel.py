...
from fixtures import get_test_mesh, get_test_field_data, get_test_model
...
class TestScalarField(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, self.field_values = get_test_field_data(NODES, SCALAR)
...
class TestVectorField(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, self.field_values = get_test_field_data(NODES, VECTOR)
        self.field = Field(self.field_name,
                           self.field_values,
                           self.field_position,
                           self.field_type)
    ...
    def test_get_3d_field_values(self):
        ...
        _, field_values = get_test_field_data(NODES, VECTOR)
...
class TestTensorField(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, self.field_values = get_test_field_data(ELEMENTS, TENSOR)
        self.field = Field(self.field_name,
                           self.field_values,
                           self.field_position,
                           self.field_type)
    ...
    def test_get_3d_field_values(self):
        ...
        _, field_values = get_test_field_data(ELEMENTS, TENSOR)
        field_values = np.asarray(field_values)
        zero_column = np.zeros((len(field_values), 1))
...
class TestElementRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        (self.node_tags,
         ...
         self.element_tags,
         self.element_types,
         self.connectivity) = get_test_mesh()
...
class TestNodeRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.node_tags, self.node_coords, _, _, _ = get_test_mesh()
...
class TestElementFieldRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, scalar_field_vals = get_test_field_data(ELEMENTS, SCALAR)
        _, vector_field_vals = get_test_field_data(ELEMENTS, VECTOR)
        _, tensor_field_vals = get_test_field_data(ELEMENTS, TENSOR)
...
class TestNodeFieldRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        _, scalar_field_vals = get_test_field_data(NODES, SCALAR)
        _, vector_field_vals = get_test_field_data(NODES, VECTOR)
        _, tensor_field_vals = get_test_field_data(NODES, TENSOR)
...
class TestParaqusModelFields(unittest.TestCase):
    ...
    def test_add_node_field(self):
        ...
        field_tags, field_vals = get_test_field_data(NODES, SCALAR)
    ...
    def test_add_element_field(self):
        ...
        field_tags, field_vals = get_test_field_data(ELEMENTS, VECTOR)
    ...
    def test_pad_scalar_field_values(self):
        ...
        field_tags, field_vals = get_test_field_data(ELEMENTS, SCALAR)
    ...
    def test_pad_vector_field_values(self):
        ...
        field_tags, field_vals = get_test_field_data(NODES, VECTOR)
    ...
    def test_pad_tensor_field_values(self):
        ...
        field_tags, field_vals = get_test_field_data(ELEMENTS, TENSOR)
    ...
    def test_get_node_fields_by_type(self):
        ...
        scalar_tags, scalar_vals = get_test_field_data(NODES, SCALAR)
        vector_tags, vector_vals = get_test_field_data(NODES, VECTOR)
        tensor_tags, tensor_vals = get_test_field_data(NODES, TENSOR)
    ...
    def test_get_element_fields_by_type(self):
        ...
        scalar_tags, scalar_vals = get_test_field_data(ELEMENTS,
                                                              SCALAR)
        vector_tags, vector_vals = get_test_field_data(ELEMENTS,
                                                              VECTOR)
        tensor_tags, tensor_vals = get_test_field_data(ELEMENTS,
                                                              TENSOR)
