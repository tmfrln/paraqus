...
from paraqus.mapping import Mapper
...
# Note, that it is not guaranteed that all elements implemented here will work
# because i do not know if there are some elements that do not support the
# COORD field output
    
ABQ_ELEMENT_LIBRARY = Mapper({
