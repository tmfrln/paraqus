...
"""
Export selected results from a simulation of an extrusion process. This
example was provided by Lennart Sobisch and is not part of the example
problems shipped with Abaqus.
...
After the file 'extrusion.odb' has been created, run this script in the
Abaqus Python interpreter via:
...
INSTANCE_NAMES = ["EXTRUDEINSTANCE",
                  "MATRIXINSTANCE"]  # Which instances will be exported
...
# Request only the scalar sdvs stored in position 1 and 11 to
