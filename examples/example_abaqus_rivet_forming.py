...
Datails on this example are available in the Abaqus Example Problems
Guide:

    Example Problems -> Dynamic Stress/Displacement Analyses -> Eulerian
    and co-simulation analyses -> Rivet forming
...
Caution: This might take up to an hour. If you machine has less than 4
CPUs, adjust the domains and cpus parameters. If you want to test the
...
After the file 'Rivet-Forming-CEL.odb' has been created, run this script
in the Abaqus Python interpreter via:
...
- Mapping of the volume fraction from element centers to nodes
  (CellDatatoPointData filter)
- Extraction of the isosurface representing the boundary of the rivet
  (Isovolume filter)
- Coloring according to the variable PEEQVAVG (choose in the menu for
  the last filter)
